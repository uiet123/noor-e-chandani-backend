const CollectionData = [
  {
    ...
    slug: "dating",
    name: "Dating",
    image: "/uploads/collection_cover/dating_col.jpg",
    description: "Romantic scents for cozy evenings and special dates.",
    products: [
      {
        name: "Rose Romance",
...

  {
    ...
    slug: "festival",
    name: "Festival",
    image: "/uploads/collection_cover/festival_col.jpg",
    description: "Light up every celebration with elegance.",
    products: [
      {
        name: "Diwali Glow",
      ...
      {
        name: "Holi Fruity",
        image: "/uploads/festival_collection/holi_fruity.png",
        description: "Just like the vibrant colors of Holi.",
        price: 200
      },
      {
...

  {
    ...
    slug: "wellness",
    name: "Wellness",
    image: "/uploads/collection_cover/wellness_col.jpg",
    description: "A calming range crafted to soothe the senses and restore balance.",
    products: [
      {
  ...
  {
    id: 4,
    slug: "everyday_comfort",
    name: "Everyday Comfort",
    image: "/uploads/collection_cover/everyday_col.jpg",
    description: "Designed to add warmth and ease to your daily moments.",
    products: [
      {
        name: "Plain Pillar",
...

  {
    ...
    slug: "gift_set",
    name: "Gift Sets",
    image: "/uploads/collection_cover/giftset_col.jpg",
    description: "Celebrate every occasion with the Noor-e-Chandani Gift Sets.",
    products: [
      {
        name: "Corporate Gift",
        image: "/uploads/gift_sets/corporate_gift.png",
        description: "A refined candle set crafted to impress.",
        price: 200
      },
      {
        name: "Couple Candle Gift Box",
        image: "/uploads/gift_sets/couple_candle_gift_box.png",
        description: "A romantic candle duo that celebrates love.",
        price: 200
      },
      {
        name: "Festival Hamper",
        image: "/uploads/gift_sets/festival_hamper.png",
        description: "A joyful hamper filled with festive radiance.",
        price: 200
      },
      {
        name: "Luxury Combo",
        image: "/uploads/gift_sets/luxury_combo.png",
        description: "An indulgent assortment of premium candles.",
        price: 200
      },
      {
        name: "Mini Jars Trio",
        image: "/uploads/gift_sets/mini_jars_trio.png",
        description: "A delightful trio of mini candles with varied fragrances.",
        price: 200
      }
    ]
  }
